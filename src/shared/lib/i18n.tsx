...
const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    drinks: 'Drinks',
    longestDrinkingStreak: 'Longest drinking streak',
    longestSoberStreak: 'Longest sober streak',
    topTypes: 'Top types',
    quantity: 'Quantity',
    liters: 'Liters',
  ...
  ru: {
    ...
    drinks: 'Напитков',
    longestDrinkingStreak: 'Макс. дней подряд пил',
    longestSoberStreak: 'Макс. дней подряд не пил',
    topTypes: 'Топ типов',
    quantity: 'Количество',
    liters: 'Литры',
